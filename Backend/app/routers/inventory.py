...
router = APIRouter(prefix="/inventory", tags=["Inventory"], dependencies=[Depends(require_role(roles["admin"]))])
...
@router.get("/pharmacy/{pharmacy_id}", response_model=List[Inventory], status_code=200)
